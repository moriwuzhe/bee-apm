...
import org.xi.lt.agent.plugin.elasticsearch.handler.ElasticsearchHandler;

/**
 * Elasticsearch方法拦截Advice
 * @author LT Monitor Dev
 * @date 2026/04/03
 */
public class ElasticsearchAdvice {
    private static ElasticsearchHandler handler = new ElasticsearchHandler();
