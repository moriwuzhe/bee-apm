 ...
 * @date 2019/12/20
 */
@SupportedAnnotationTypes({"org.xi.lt.common.annotation.LtPlugin"})
public class LtAnnotationProcessorImpl extends AbstractProcessor {
    @Override
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element e : roundEnv.getElementsAnnotatedWith(LtPlugin.class)) {
            LtPlugin annotation = e.getAnnotation(LtPlugin.class);
            if (annotation == null) {
                continue;
            }
        ...
        for (Map.Entry<String, List<String>> entry : serviceMap.entrySet()) {
            ...
            String fileName = "lt-" + entry.getKey() + ".def";
            try {
