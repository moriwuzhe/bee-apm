...
public class PreprodLoadRunner {
    ...
    @Value("${lt.demo.load.enable:false}")
    private boolean enable;

    @Value("${lt.demo.load.qps:5}")
    private int qps;

    @Value("${lt.demo.load.threads:2}")
    private int threads;

    @Value("${lt.demo.load.durationSeconds:0}")
    private int durationSeconds;

    @Value("${lt.demo.load.entryPath:/hello/sayHello}")
