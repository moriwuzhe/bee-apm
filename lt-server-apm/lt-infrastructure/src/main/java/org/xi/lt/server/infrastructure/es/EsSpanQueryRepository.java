...
public class EsSpanQueryRepository implements SpanQueryRepository {
    ...
    public PageSearchResult<SpanView> searchPage(SpanPageQuery query) throws Exception {
        ...
        org.xi.lt.server.domain.model.SortDirection sortDirection = query == null ? org.xi.lt.server.domain.model.SortDirection.DESC : (query.getSortDirection() == null ? org.xi.lt.server.domain.model.SortDirection.DESC : query.getSortDirection());
