package org.xi.lt.server.web.interfaces.http.controller.management;
...
public class AgentControlController {
    ...
    @GetMapping("/api/agent/config/pull")
    ...
    @GetMapping("/api/agent/instances")
    ...
    @PostMapping("/api/agent/config/update")
    ...
    @GetMapping(value = "/api/agent/install.sh", produces = "text/plain;charset=UTF-8")
