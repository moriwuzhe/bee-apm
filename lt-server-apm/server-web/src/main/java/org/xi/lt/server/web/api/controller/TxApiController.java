...
public class TxApiController {
    ...
    public PageResult<Map<String, Object>> list(@RequestBody Map<String, Object> req) {
        ...
        BoolQueryBuilder q = QueryBuilders.boolQuery()
                .must(QueryBuilders.termQuery("type.keyword", "tx"))
        ...
        try {
            EsSearchService.PageSearchResult r = es.searchPage("bee-tx-*", q, sortField, SortOrder.DESC, (pageNum - 1) * PAGE_SIZE, PAGE_SIZE);
