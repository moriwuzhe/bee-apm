...
public class CommonUseCase {
    @Autowired
    private CommonQueryRepository repo;
    ...
    public ApiResult<List<KeyValue>> getGroupList(CommonGetGroupListRequest req) {
        ...
        return ResultHelper.success(repo.groupList(beginMs, endMs, field));
    }
    ...
    public ApiResult<Object> queryById(CommonQueryByIdRequest req) {
        ...
        return ResultHelper.success(repo.queryById(req.getIndex(), req.getId(), beginMs, endMs));
    }
}
