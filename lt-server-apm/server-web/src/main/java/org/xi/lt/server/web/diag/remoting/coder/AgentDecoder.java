package org.xi.lt.server.web.diag.remoting.coder;
...
import org.xi.lt.server.web.diag.remoting.protocol.RemotingHeader;
import org.xi.lt.server.web.diag.remoting.util.JsonUtils;
import org.xi.lt.server.web.diag.remoting.util.PayloadHolderUtils;
...
public class AgentDecoder extends ByteToMessageDecoder {
    private static final TypeReference<Map<String, String>> PROPERTIES_TYPE = new TypeReference<Map<String, String>>() {
    };
