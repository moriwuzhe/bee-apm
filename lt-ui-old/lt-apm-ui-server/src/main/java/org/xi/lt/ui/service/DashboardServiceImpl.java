...
import org.xi.lt.ui.common.DateUtils;
...
public class DashboardServiceImpl implements IDashboardService {
    ...
    public ResultVo getRequestBarData(Map<String,Object> params){
        ...
        try {
            SearchResult result = EsJestClient.inst().search(params, "RequestBar", "lt-request-");
    ...
    public ChartVo getRequestLineData(Map<String, Object> params) {
        ...
        try {
            Long beginTime = LtUtils.getBeginTime(params);
            Long endTime = LtUtils.getEndTime(params);
            Map<String, String> args = new HashMap<>();
            args.put("beginTime", beginTime.toString());
            args.put("endTime", endTime.toString());
            String[] timeInfo = LtUtils.parseDateInterval(new Date(beginTime),new Date(endTime));
            ...
            String[] indices = LtUtils.getIndices("lt-request-", params);
    ...
    public Long queryRequestCount(Map<String, Object> params) {
        return queryCount("lt-request-",params);
    }

    @Override
    public Long queryErrorCount(Map<String, Object> params) {
        return queryCount("lt-error-",params);
    }
    ...
    public ResultVo queryErrorPieData(Map<String, Object> params) {
        ResultVo res = new ResultVo();
        try {
            SearchResult result = EsJestClient.inst().search(params, "errorPie", "lt-error-");
            if(404 == result.getResponseCode()){
                res.setCode("-1");
                res.setResult(new ArrayList<>());
                return res;
    ...
    public ResultVo queryErrorLineData(Map<String, Object> params) {
        ...
        try {
            ...
            String[] indices = LtUtils.getIndices("lt-error-", params);
            SearchResult result = EsJestClient.inst().search(indices,null,queryString);
            if(404 == result.getResponseCode()){
                res.setCode("-1");
            ...
            while (!appDateNumMap.isEmpty()) {
                ...
                rowList.add(row);
                beginDate = LtUtils.nextDateTime(beginDate,timeInfo[0]);
