...
import org.xi.lt.ui.model.TopologyEdge;
import org.xi.lt.ui.model.vo.BaseVo;
...
public class RequestServiceImpl implements IRequestService {
    ...
    public TableVo list(Map<String, Object> params) {
        ...
        params.put("from", (res.getPageNum() - 1) * LtConst.PAGE_SIZE);
        params.put("size", LtConst.PAGE_SIZE);
    ...
    public ChartVo chart(Map<String, Object> params) {
        ...
        try {
            ...
            String[] indices = LtUtils.getIndices(EsIndicesPrefix.REQUEST, params);
